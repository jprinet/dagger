...
public abstract class AggregatedDepsMetadata {
  ...
  private static ImmutableSet<TypeElement> getComponents(
    ...
    Preconditions.checkNotNull(componentsValue);
    ImmutableSet<TypeElement> componentNames =
        AnnotationValues.getAnnotationValues(componentsValue).stream()
            ...
            .collect(toImmutableSet());
    Preconditions.checkState(!componentNames.isEmpty());
  ...
  private static DependencyType getDependencyType(
    ...
    Preconditions.checkNotNull(modulesValue);
    Preconditions.checkNotNull(entryPointsValue);
    Preconditions.checkNotNull(componentEntryPointsValue);
    ...
    return Iterables.getOnlyElement(dependencyTypes.build());
  }
  ...
  private static TypeElement getDependency(
    ...
    Preconditions.checkNotNull(dependency, "Could not get element for %s", dependencyName);
    return dependency;
  }
