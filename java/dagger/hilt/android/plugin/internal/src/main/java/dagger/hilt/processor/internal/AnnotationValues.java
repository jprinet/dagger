...
public final class AnnotationValues {
  ...
  public static TypeElement getTypeElement(AnnotationValue value) {
    return MoreTypes.asTypeElement(getTypeMirror(value));
  }
  ...
  public static int getIntValue(AnnotationMirror annotation, String valueName) {
    return (int) AnnotationMirrors.getAnnotationValue(annotation, valueName).getValue();
  }
  ...
  public static int[] getIntArrayValue(AnnotationMirror annotation, String valueName) {
    return getAnnotationValues(AnnotationMirrors.getAnnotationValue(annotation, valueName)).stream()
